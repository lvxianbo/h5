...
Main.ortchange = function(bool) {
	...
	var w=$('#Layer_1').width();
	var h=w/ (595.28 /841.89 ) ;
	$('#Layer_1').attr('height',h+'px')
	$('.page_box').css('height',Main.height+'px')
	Main.id_audio=$('#id_audio').attr('src','http://static.sinreweb.com/2015/jdb/images/bb.mp3?v=1.'+Math.random()*9999).get(0);
...
Main.On = function() {	
    ...
    Main.index=0;    
    $('.img_15').on('touchstart click',function(e){
    	e.preventDefault();
    	
    	//setTimeout(function(){
    		$('.page_box_8').addClass('current1')
    		//setTimeout(function(){
    			
    		//},13000)
    	//},1000)
    })
    $('.img_20').on('touchstart click',function(e){
    	//alert('a');
    	$('.page_f').addClass('current');
    })
    $('.img_22').on('touchstart click',function(){
...
$(function(){
	Main.init();	
	var img=new Image();
	img.src=Main.imgurl+'http://static.sinreweb.com/2015/jdb/images/bg1_02.jpg';	
	if(img.complete){		
		onload();				
		return ;
	}	
...
Main.imgs=['http://static.sinreweb.com/2015/jdb/images/bg2_02.jpg','http://static.sinreweb.com/2015/jdb/images/bg3_02.jpg','http://static.sinreweb.com/2015/jdb/images/a1_11.png',
'http://static.sinreweb.com/2015/jdb/images/a2_11.png','http://static.sinreweb.com/2015/jdb/images/b1_13.png','http://static.sinreweb.com/2015/jdb/images/c1_09.png','http://static.sinreweb.com/2015/jdb/images/d1_09.png','http://static.sinreweb.com/2015/jdb/images/ff1_02.png','http://static.sinreweb.com/2015/jdb/images/g1_09.png','http://static.sinreweb.com/2015/jdb/images/i1_02.png',
'http://static.sinreweb.com/2015/jdb/images/j1_03.png','http://static.sinreweb.com/2015/jdb/images/j2_07.png','http://static.sinreweb.com/2015/jdb/images/n1_03.png','http://static.sinreweb.com/2015/jdb/images/s1_03.png','http://static.sinreweb.com/2015/jdb/images/s2_03.png','http://static.sinreweb.com/2015/jdb/images/s3_03.png','http://static.sinreweb.com/2015/jdb/images/s4_03.png',
'http://static.sinreweb.com/2015/jdb/images/s5_03.png','http://static.sinreweb.com/2015/jdb/images/s6_03.png','http://static.sinreweb.com/2015/jdb/images/s7_03.png'];
//滑动
var y,y2=0,index=0;
Main.scrolbody=function(){			
	...
	$(document.body).get(0).addEventListener('touchend',function(e){	
		if(Main.scrollbool==false || y2==0  ){
			y=y2=0;
			$('.page_index').css({y:-Main.index*Main.height+'px'});
			return ;
		}	
		if(y-y2>5 &&  Main.index<7 ){
		    Main.index+=1;			   
			$('.page_index').transition({y:-Main.index*Main.height+'px'},400);
			...
			setTimeout(function(){
				...
				if(Main.index==7){
				    //$("#example-line-container").css('opacity','1');
				    hi.reset().play();
			    }
			},100)
			...
			if(Main.index<8){		    	
		    	$('.img_move').transition({y:'20px',opacity:0},0)		   
			}
		}else{
			$('.page_index').css({y:-Main.index*Main.height+'px'});
		}		
